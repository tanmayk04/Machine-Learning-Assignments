...
def main():
	...
	for i in ip:
		...
		u.append(float(i[2]))
		gen.append(i[3])
	# creating an array to record the forecast for each of the given points
	arrpt=[]
	...
	for z in range(len(rqrdpt1)):
		if rqrdpt1[z][1]==1:
			xes.plot(rqrdpt1[z][0][0],rqrdpt1[z][0][1],rqrdpt1[z][0][2],'.b')
		else:
			xes.plot(rqrdpt1[z][0][0],rqrdpt1[z][0][1],rqrdpt1[z][0][2],'.y')
	pt.show()
	print('END Q3_C\n')
